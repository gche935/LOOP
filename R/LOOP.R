...
print(lavaan::summary(CLPMMLR.fit, fit.measure = T, standardized = T, rsq = T))
### ###
...
# Request summary outputs
cat(rep("\n",2), "  print(lavaan::summary(CLPMMLR.fit, fit.measure = T, standardized = T, rsq = T))", "\n")
...
### Request Summary Outputs ###
print(lavaan::summary(RICLPMMLR.fit, fit.measure = T, standardized = T, rsq = T))
### ###
...
# Request summary outputs
cat(rep("\n",2), "  print(lavaan::summary(RICLPMMLR.fit, fit.measure = T, standardized = T, rsq = T))", "\n")
